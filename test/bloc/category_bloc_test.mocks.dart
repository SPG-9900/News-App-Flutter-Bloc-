...
// in news/test/bloc/category_bloc_test.dart.
...
import 'package:news/models/article.dart' as _i4;
...
class MockNewsRepository extends _i1.Mock implements _i2.NewsRepository {
  ...
  @override
  _i3.Future<List<_i4.Article>> getArticlesByCategory(String? category) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i3.Future<_i4.Article?> getArticleById(String? id) => (super.noSuchMethod(
        Invocation.method(
          #getArticleById,
          [id],
        ),
